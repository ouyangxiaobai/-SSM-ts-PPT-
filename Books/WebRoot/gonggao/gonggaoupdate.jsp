...
<script language="javascript" type="text/javascript" src="js/jquery.min.js"></script>
	...
	<body>
<form action="method!gonggaoupdate2" method="post"  >
            ...
            <div class="box_center">
               ...
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><input type="text" name="biaoti" id="biaotiid" value="${bean.biaoti }" class="input-text lh30" size="40"/></td>
                </tr>
                <tr>
                  <td class="td_right">内容:</td>
                  <td><textarea class="textarea" name="content" id="contentid" rows="5" cols="30">${bean.content }</textarea></td>
                </tr>
